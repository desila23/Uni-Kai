...
1. Alice genera una chiave segreta casuale per cifrare il messaggio con un algoritmo veloce, poi cifra quella chiave con la chiave pubblica di Bob.  
2. Bob decifra prima la chiave segreta e poi il messaggio.  
...
- Un **avversario passivo** (eavesdropper) può **intercettare i messaggi** ma **non li altera**.  
    Il suo obiettivo è leggere informazioni riservate, e la **crittografia** serve a difendersi da questo tipo di minaccia.
...
- Un **avversario attivo** può invece **modificare, falsificare o dirottare** i messaggi durante la trasmissione.  
    ...
    Contro questi attacchi servono strumenti che garantiscano **autenticità e integrità**, come **MAC** e **firme digitali**.
![[Pasted image 20251007173959.png|center|400]]
