...
- → È un modo per interpretare il mondo senza ripartire da zero ogni volta.
	- tipo con i negri, lo stereotipo è "i negri rubano e il ladro è uno sporco negro" - qui abbiamo ben due stereotipo "ruba(negro)" e "sporco(negro)" MA QUESTI SI ADATTANO AL CASO SPECIFICO, NON AL PIÙ GENERALE.
...
- Organizzare  frame in una sorta di gerarchia o sistema concettuale**
...
### Metodo più usato per rappresentare la KB: Knowledge Graph
