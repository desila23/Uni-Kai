...
4) Dobbiamo descrivere ora la risposta del problema
	Per farlo, definiamo una funzione $\rho$ che associa, all'insieme delle soluzioni effettive per l'istanza `n`, una risposta scelta nell'insieme `R` delle risposte
